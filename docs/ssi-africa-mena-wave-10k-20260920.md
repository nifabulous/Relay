...
This standalone ledger contributes 56 additional beneficiary/currency/intermediary
...
| AfrAsia Bank Limited | `AFBLMUMUXXX` | 2 | [Correspondent-bank table](https://www.afrasiabank.com/en/international/correspondent-banks) |
...
| Bank of Baroda (Seychelles) Limited | `BARBSCSCXXX` | 2 | [Cross-border SWIFT page](https://www.bankofbaroda.sc/services/remittance-facility/cross-border-transfer-swift) |
