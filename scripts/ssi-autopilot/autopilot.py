...
def _expand_batch8_source_rows() -> list[tuple[str, ...]]:
    """Read the bounded batch-8 Grasshopper ledger without executing seed.py."""
    ...
    for node in tree.body:
        ...
        for element in node.value.elts:
            if (
                ...
                and element.value.func.id in {"_ssi_batch4_records", "_ssi_batch5_records", "_ssi_batch6_records", "_ssi_batch7_records", "_ssi_batch8_records"}
            ):
                rows.extend({
    ...
    for node in tree.body:
        ...
        for i, e in enumerate(elts):
            if (
                ...
                and e.value.func.id in {"_ssi_batch4_records", "_ssi_batch5_records", "_ssi_batch6_records", "_ssi_batch7_records", "_ssi_batch8_records"}
            ):
                continue
