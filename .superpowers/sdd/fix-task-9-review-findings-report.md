...
- `npm run test:e2e -- e2e/preferences-menu.spec.ts e2e/design-system-foundation.spec.ts --project=desktop --project=case-mobile-390` — 5 passed, 1 intentional viewport skip.
...
- `npm test` — 90 files, 1,273 tests passed.
- `npm ci --dry-run --ignore-scripts` — passed.
- `git diff --check` — passed.
